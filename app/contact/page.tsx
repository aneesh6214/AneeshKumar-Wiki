        ...
        <main className="flex-1 w-full md:w-4/5">
          ...
          <div className="px-4 sm:px-6 py-4">
            <div className="flex items-center justify-between mb-2">
              <h1 className="text-2xl sm:text-3xl font-serif text-black">Aneesh Kumar - Contact</h1>
              <div className="flex items-center gap-2 text-sm">
              ...
              <div className="mb-6">
                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6 text-center">
                  ...
                  <p className="text-gray-700 mb-4">
                    This section is currently under development. Contact information and professional links will be
                    added soon.
                  </p>
                  <p className="text-sm text-gray-600">
                    For inquiries, please check back later or refer to{" "}
                    <Link href="/" className="text-blue-600 hover:underline">
                      Aneesh Kumar
                    </Link>
                    's main page for general information.
                  </p>
                </div>
              </div>
            </div>
