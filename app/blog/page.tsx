        ...
        <aside className="w-full md:w-1/5 md:min-w-[240px] bg-white border-r border-gray-200 min-h-screen md:sticky md:top-0 md:h-screen overflow-y-auto">
          <div className="p-4">
            ...
            <nav className="space-y-1 text-sm">
              ...
              <div className="py-1">
                <Link href="/blog" className="text-blue-600 hover:underline font-medium bg-blue-50 px-2 py-1 rounded">
                  Blog
                </Link>
              </div>
        ...
        <main className="flex-1 w-full md:w-4/5">
          ...
          <div className="px-4 sm:px-6 py-4">
            <div className="flex items-center justify-between mb-2">
              <h1 className="text-2xl sm:text-3xl font-serif text-black">Aneesh Kumar - Blog</h1>
              <div className="flex items-center gap-2 text-sm">
              ...
              <div className="mb-6">
                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6 text-center">
                  ...
                  <p className="text-gray-700 mb-4">
                    This section is currently under development. Blog content and technical articles will be added soon.
                  </p>
                  <p className="text-sm text-gray-600">
                    Check back later for updates on technical topics, tutorials, and insights from{" "}
                    <Link href="/" className="text-blue-600 hover:underline">
                      Aneesh Kumar
                    </Link>
                    's work in software engineering and technology.
                  </p>
                </div>
              </div>
            </div>
